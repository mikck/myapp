...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        var map = this.map = new AMap.Map(this.map_container.nativeElement, {
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Users/hongcan.cai.o/ionic/app/myapp/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/hongcan.cai.o/ionic/app/myapp/src/pages/list/list.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        // used for an example of ngFor and navigation
        this.menu = [
            { title: '项目管理', component: 'managerpro' },
            { title: '地图管理', component: 'managermap' },
            { title: '版本号：v1.0.1', component: 'managermap' }
        ];
    }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/hongcan.cai.o/ionic/app/myapp/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n      <button menuClose ion-item *ngFor="let p of menu" (click)="doaction(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Users/hongcan.cai.o/ionic/app/myapp/src/app/app.html"*/
        }),
